...
async def pause(_, message: Message):
    if (
        ...
        await message.reply_text("❗ Tidak ada yang di putar")
    else:
...
async def resume(_, message: Message):
    if (
        ...
        await message.reply_text("⏸ Berhenti sementara!")
...
async def stop(_, message: Message):
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_text("❌ Stop musik!")
...
async def skip(_, message: Message):
    global que
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❗ Tidak ada musik untuk di skip!")
    else:
